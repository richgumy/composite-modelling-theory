# Finds and displays a number of polyominoes (referred to as lattice animals in percolation theory)

# Program from https://rosettacode.org/wiki/Free_polyominoes_enumeration#Python
